...
#ifndef ORION_GRADIENT_LUT_H__
#define ORION_GRADIENT_LUT_H__
...
private:
  orion::dda_line_interpolator<14> r, g, b, a;
};
...
private:
  orion::dda_line_interpolator<14> v, a;
};
...
private:
  ...
  typedef orion::pod_bvector<color_point, 4> color_profile_type;
  typedef orion::pod_array<color_type> color_lut_type;
