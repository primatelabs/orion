...
#ifndef ORION_BLUR_H__
#define ORION_BLUR_H__
...
template <class T>
int16u const stack_blur_tables<T>::g_stack_blur8_mul[255] = {512, 512, 456, 512,
  328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364,
  328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454,
  428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437,
  420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512,
...
template <class T>
int8u const stack_blur_tables<T>::g_stack_blur8_shr[255] = {9, 11, 12, 13, 13,
  14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18,
...
public:
  ...
  void blur_x(Img& img, double radius)
  {
    ...
    calc_type q = calc_type((s < 2.5) ? 3.97156 - 4.14554 * sqrt(1 - 0.26891 * s)
                                      : 0.98711 * s - 0.96330);
    ...
    calc_type b0 =
      calc_type(1.0 / (1.578250 + 2.444130 * q + 1.428100 * q2 + 0.422205 * q3));
    ...
    for (y = 0; y < h; y++) {
      ...
      m_sum2[wm - 1]
        .calc(b, b1, b2, b3, m_sum1[wm - 1], m_sum2[wm], m_sum2[wm], m_sum2[wm]);
      m_sum2[wm - 2]
        .calc(b, b1, b2, b3, m_sum1[wm - 2], m_sum2[wm - 1], m_sum2[wm], m_sum2[wm]);
...
private:
  orion::pod_vector<calculator_type> m_sum1;
  orion::pod_vector<calculator_type> m_sum2;
  orion::pod_vector<color_type> m_buf;
};
