...
#ifndef ORION_MATH_H__
#define ORION_MATH_H__
...
AGG_INLINE double cross_product(double x1,
  double y1,
  double x2,
  double y2,
  double x,
...
AGG_INLINE double calc_line_point_distance(double x1,
  double y1,
  double x2,
  double y2,
  double x,
...
AGG_INLINE double calc_segment_point_u(double x1,
  double y1,
  double x2,
  double y2,
  double x,
...
AGG_INLINE double calc_segment_point_sq_distance(double x1,
  ...
  double y)
{
  return calc_segment_point_sq_distance(x1,
    y1,
    x2,
    y2,
    x,
...
AGG_INLINE double calc_triangle_area(double x1,
  double y1,
  double x2,
  double y2,
  double x3,
