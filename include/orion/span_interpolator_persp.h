...
#ifndef ORION_SPAN_INTERPOLATOR_PERSP_H__
#define ORION_SPAN_INTERPOLATOR_PERSP_H__
...
public:
  ...
  span_interpolator_persp_exact(double x1,
    double y1,
    double x2,
    double y2,
    const double* quad)
...
public:
  ...
  // Direct transformations
  span_interpolator_persp_lerp(double x1,
    double y1,
    double x2,
    double y2,
    const double* quad)
