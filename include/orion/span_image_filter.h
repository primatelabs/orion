...
#ifndef ORION_SPAN_IMAGE_FILTER_H__
#define ORION_SPAN_IMAGE_FILTER_H__
...
public:
  ...
  void blur_x(double v)
  {
    m_blur_x = uround(v * double(image_subpixel_scale));
  }
  void blur_y(double v)
  {
  ...
  void blur(double v)
  {
    m_blur_x = m_blur_y = uround(v * double(image_subpixel_scale));
  }
