...
#ifndef ORION_RENDERER_MARKERS_H__
#define ORION_RENDERER_MARKERS_H__
...
public:
  ...
  void diamond(int x, int y, int r)
  {
    if (visible(x, y, r)) {
      if (r) {
        ...
        int dx = 0;
        do {
          base_type::ren().blend_pixel(x - dx,
            y + dy,
            base_type::line_color(),
            cover_full);
          base_type::ren().blend_pixel(x + dx,
            y + dy,
            base_type::line_color(),
    ...
    if (visible(x, y, r)) {
      if (r) {
        ...
        do {
          ...
          base_type::ren().blend_pixel(x + dy,
            y + dx,
            base_type::line_color(),
            cover_full);
          base_type::ren().blend_pixel(x + dy,
  ...
  void semiellipse_up(int x, int y, int r)
  {
    if (visible(x, y, r)) {
      if (r) {
        ...
        base_type::ren().blend_hline(x - dx,
          y - dy - 1,
          x + dx,
          base_type::line_color(),
          cover_full);
  ...
  void markers(int n, const T* x, const T* y, T r, marker_e type)
  {
    ...
    if (r == 0) {
      do {
        base_type::ren().blend_pixel(int(*x),
          int(*y),
          base_type::fill_color(),
          cover_full);
        ++x;
