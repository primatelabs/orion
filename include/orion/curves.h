...
#ifndef ORION_CURVES_H__
#define ORION_CURVES_H__
...
inline curve4_points catrom_to_bezier(double x1,
  double y1,
  double x2,
  double y2,
  double x3,
...
inline curve4_points ubspline_to_bezier(double x1,
  double y1,
  double x2,
  double y2,
  double x3,
...
inline curve4_points hermite_to_bezier(double x1,
  double y1,
  double x2,
  double y2,
  double x3,
