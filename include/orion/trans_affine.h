...
#ifndef ORION_TRANS_AFFINE_H__
#define ORION_TRANS_AFFINE_H__
...
//
// orion::trans_affine m;
// m *= orion::trans_affine_rotation(30.0 * 3.1415926 / 180.0);
// m *= orion::trans_affine_scaling(2.0, 1.5);
// m *= orion::trans_affine_translation(100.0, 100.0);
// m.transform(&x, &y);
//
...
//
// m *= orion::trans_affine_translation(-100.0, -100.0);         // move to
// (0,0)
// m *= orion::trans_affine_rotation(30.0 * 3.1415926 / 180.0);  // rotate
// m *= orion::trans_affine_translation(100.0, 100.0);           // move back to
// (100,100)
...
struct trans_affine {
  ...
  const trans_affine& rect_to_parl(double x1,
    double y1,
    double x2,
    double y2,
    const double* parl);
